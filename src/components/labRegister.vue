        ...
        <div class="login-box-body">
          ...
          <form method="post" id="login-form">
            <div class="form-group has-feedback ">
              <input type="text" class="form-control" name="orgId" placeholder="请输入实验室名称" v-model="form.name">
  ...
  methods:{
    ...
    register () {//短信验证成功开始注册
      ...
      if(this.userName == "" || this.password == ""){
        ...
        $.ajax({
          type:'post',
          url:'http://localhost:8086/kuaixiu-web/user/register',
          data:JSON.stringify($("#login-form").serialize()),
          dataType:'json',
          contentType: "application/json; charset=utf-8",
//                    headers: {
